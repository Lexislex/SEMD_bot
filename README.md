...
Версия: **2.1.0** | Архитектура: **Модульная с системой плагинов (Plugin-based)** | Community: **Fork + Pull Request**
...
│   ├── nsi_update_checker/   # Мониторинг обновлений НСИ
...
- [`plugins/root_menu/`](plugins/root_menu/) — Главное меню (шаблон)
- [`plugins/semd_checker/`](plugins/semd_checker/) — Плагин с командами
- [`plugins/nsi_update_checker/`](plugins/nsi_update_checker/) — ScheduledPlugin
- [`plugins/statistics/`](plugins/statistics/) — Админский плагин
...
## 📊 Последние изменения (Nov 2025, v2.1.0)

### ✅ Модульная архитектура с поддержкой community плагинов

- Полностью переработана система плагинов
- Добавлена поддержка Fork + Pull Request разработки
- Создан полный гайд для разработчиков ([`docs/PLUGIN_DEVELOPMENT_GUIDE.md`](docs/PLUGIN_DEVELOPMENT_GUIDE.md))
- Все плагины имеют README.md с описанием
- Система готова к масштабированию и развитию community

### ✅ Новые плагины

- 🏠 **Root Menu Plugin** — центральная маршрутизация (новый)
- ⚙️ **Admin Logs Plugin** — логи системы (в разработке)
- 🔌 **Plugin Manager Plugin** — управление плагинами (в разработке)
...
- Исправлены критические ошибки в логировании и type hints
- Удалены неиспользуемые импорты
- Удален dead code
- Исправлены typo
- 100% заполнены названия справочников НСИ
...
**Последнее обновление:** Nov 2025 | **Версия:** 2.1.0 | **Статус:** ✅ Production Ready
